package sanhack.hygienotronics.data;
...
public abstract class Preferences {
    ...
    //public static final int ALERT_DELAY = 10000;
    public static final long SHOW_MOTION_DURATION = 5000;
    // Time between saving photos
    public static int PICTURE_DELAY = 5000;
	//before we raise alarm for someone not washing hands!
	public static final int EXPECT_HANDWASH_DELAY = 15000;
